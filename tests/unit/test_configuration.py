...
class TestConfiguration:
    ...
    def test_environment_variable_precedence(self):
        ...
        config_data = {"temperature": 0.3, "max_tokens": 1000, "local_url": "http://config-file:8080"}
    ...
    def test_command_line_flag_precedence(self):
        ...
        config_data = {"local_url": "http://config:8080"}
                ...
                with patch("builtins.open", mock_open()):
                    with patch("yaml.safe_load", return_value=config_data):
                        ...
                        trace_clean = TraceClean(
                            model="gpt-4", api_key="explicit-key", local_url="http://explicit:9000"
                        )
    ...
    def test_local_url_validation(self):
        ...
        config_with_valid_url = {"local_url": "http://valid:8080"}
    ...
    def test_config_values_used_in_api_calls(self):
        ...
        config_data = {"temperature": 0.8, "max_tokens": 2500}
            ...
            with patch("builtins.open", mock_open()):
                with patch("yaml.safe_load", return_value=config_data):
                    ...
                    with patch("openai.OpenAI") as mock_openai:
                        ...
                        trace_clean._call_openai("test prompt")
    ...
    def test_config_values_used_in_local_calls(self):
        ...
        config_data = {"temperature": 0.2, "max_tokens": 3000, "timeout": 180, "local_model": "custom-model"}
            ...
            with patch("builtins.open", mock_open()):
                with patch("yaml.safe_load", return_value=config_data):
                    ...
                    with patch("requests.post") as mock_post:
                        ...
                        trace_clean._call_local_model("test prompt")
    ...
    def test_config_explicit_vs_implicit_local_url(self):
        ...
        config_data = {"local_url": "http://config-file:8080"}
    ...
    def test_config_environment_interaction(self):
        ...
        config_data = {"temperature": 0.6, "local_url": "http://config:8080"}
