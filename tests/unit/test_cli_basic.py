...
class TestCLIBasic:
    ...
    def test_all_command_line_flags(self):
        ...
        args = parser.parse_args(
            ["--json", "--model", "local", "--api-key", "test-key", "--local-url", "http://localhost:9999", "error.log"]
        )
        assert args.json is True
    ...
    def test_basic_import_structure(self):
        ...
        # Test CLI imports
        from trace_clean_pkg.cli import TraceClean as CLITraceClean
        from trace_clean_pkg.cli import main as cli_main
    ...
    def test_traceclean_invalid_local_url(self):
        ...
        valid_urls = ["http://localhost:11434", "http://127.0.0.1:8080", "https://example.com:443"]
    ...
    def test_format_output_json(self):
        ...
        sample_result = {
            ...
            "suspect_functions": [
                {"function": "test_func", "file": "test.py", "line": 42, "confidence": "High", "reason": "Test reason"}
            ],
    ...
    def test_json_output_handling(self, capsys):
        ...
        sample_result = {"summary": "Test summary", "suspect_functions": [], "next_actions": []}
